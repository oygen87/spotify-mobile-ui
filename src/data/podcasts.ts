...
export const podcasts: Podcast[] = [
  {
    ...
    episodes: [
      ...
      },
      {
        ...
        chemical plant leads a cast of operational technology researchers down a strange path 
        towards an uncommon, but grave, threat. In this episode, we hear how these researchers 
        discovered this threat and tried to identify who was responsible for the malware behind it. 
